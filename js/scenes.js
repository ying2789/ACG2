            ...
            setup: function(arContent) {
                ...
                InteractionManager.createNarration(
                    ...
                    if (!talkButtonHTML) {
                        ...
                        talkButtonHTML.style.top = '230px';
            ...
            triggerDialogue: function(arContent) {
                ...
                hareAudio.play().then(() => {
                    ...
                    if (!startButtonHTML) {
                        ...
                        startButtonHTML.style.top = '230px';
                ...
                InteractionManager.createNarration(
                    ...
                    setTimeout(() => {
                        ...
                        if (!continueButtonHTML) {
                            ...
                            continueButtonHTML.style.top = '230px';
        ...
        // Scene 4: The Nap Scene - You Decide
        {
            ...
            showChoiceButtons: function(arContent) {
                ...
                if (!sleepButtonHTML) {
                    ...
                    sleepButtonHTML.style.top = '230px';
                ...
                if (!cheerButtonHTML) {
                    ...
                    cheerButtonHTML.style.top = '230px';
